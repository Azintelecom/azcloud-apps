...
func modulesMain() (*asset, error) {
	...
	info := bindataFileInfo{name: "modules/main", size: 2185, mode: os.FileMode(436), modTime: time.Unix(1616322395, 0)}
