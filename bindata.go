...
func modulesMain() (*asset, error) {
	...
	info := bindataFileInfo{name: "modules/main", size: 1026, mode: os.FileMode(436), modTime: time.Unix(1599035615, 0)}
