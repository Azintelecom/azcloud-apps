...
func modulesCore() (*asset, error) {
	bytes, err := modulesCoreBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "modules/core", size: 977, mode: os.FileMode(436), modTime: time.Unix(1598997458, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"modules": &bintree{nil, map[string]*bintree{
		"core": &bintree{modulesCore, map[string]*bintree{}},
	}},
}}
